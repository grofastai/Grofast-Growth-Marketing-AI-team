  ...
  return (
    <div style={{ padding: '24px 28px 60px', display: 'flex', flexDirection: 'column', gap: 24, background: '#F8F9FB', minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
        ...
        <KpiTile label="Wasted Cost"    emoji="⚠️"  value={fmtRupee(kpis.totalWastedCost)} sub="untracked hours × rate"                    color="#EF4444" isCost />
      ...
      <SectionCard title="Team Utilization — Wasted Hours Tracker" emoji="📋">
                  ...
                  {isExpanded && (
                    <div style={{ padding: '0 18px 14px 18px', display: 'flex', flexDirection: 'column', gap: 8 }}>
                      ...
                      <div style={{ display: 'flex', gap: 12, marginTop: 4 }}>
                        ...
                        {m.wastedCost > 0 && (
                          <div>
                            <p style={{ fontSize: 9, color: '#9CA3AF', margin: 0, textTransform: 'uppercase', fontWeight: 700 }}>Wasted</p>
