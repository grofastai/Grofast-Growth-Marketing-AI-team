...
export default function RadialOrbitalTimeline({
  ...
  if (timelineData.length === 0) {
    return (
      <div className="w-full h-96 flex items-center justify-center bg-black rounded-2xl">
        <p className="text-white/40 text-sm">No tasks to display in orbital view</p>
      </div>
    );
  }
  ...
  return (
    <div
      className="w-full flex flex-col items-center justify-center bg-black rounded-2xl overflow-hidden"
      style={{ height: 600 }}
      ref={containerRef}
    ...
    >
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          {/* Centre orb */}
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-red-600 via-red-800 to-black animate-pulse flex items-center justify-center z-10">
            ...
            return (
              ...
              >
                ...
                <div className={`
                  ...
                  ${isRelated && !isExpanded ? "bg-white/50 text-black animate-pulse" : ""}
                  ${!isExpanded && !isRelated ? "bg-black text-white" : ""}
                  border-2
                  ${isExpanded  ? "border-white shadow-lg shadow-white/30 scale-150" : ""}
                  ${isRelated && !isExpanded  ? "border-white"          : ""}
                  ${!isExpanded && !isRelated ? "border-white/40"       : ""}
                ...
                {/* Label */}
                <div className={`
                  absolute top-12 -translate-x-1/2 left-1/2 whitespace-nowrap
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      {item.category && (
                        <div className="mt-3 pt-3 border-t border-white/10">
                          <span className="text-[10px] uppercase tracking-wider text-white/50">Client</span>
