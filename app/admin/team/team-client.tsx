        ...
        <div className="flex flex-col sm:grid sm:grid-cols-[auto_1fr_auto] sm:items-center gap-3" style={{ padding: "12px 22px", position: "relative", zIndex: 1 }}>
          ...
          <div className="flex items-center gap-2 sm:gap-3 self-start sm:self-center" style={{ flexShrink: 0 }}>
            <button
              ...
              className="flex items-center gap-2 px-3 sm:px-4 py-2.5 rounded-xl text-[13px] font-bold transition-all whitespace-nowrap"
              style={{ background: "rgba(255,255,255,0.12)", color: "#FFFFFF", border: "1px solid rgba(255,255,255,0.35)" }}>
              <Users size={14} /> <span className="hidden sm:inline">Manage Teams &amp; Roles</span>
            </button>
            <button
