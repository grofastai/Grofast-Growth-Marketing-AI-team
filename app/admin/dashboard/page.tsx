            ...
            <Link key={s.label} href={s.href} style={{ textDecoration: "none", display: "block", height: "100%" }}>
              <div style={{ ...CARD, padding: "18px 20px", height: "100%", boxSizing: "border-box" }} className="hover:shadow-md transition-shadow">
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
                  ...
                  <ArrowRight size={13} style={{ color: "#000000" }} />
                </div>
                <p style={{ fontSize: 32, fontWeight: 900, color: "#111827", margin: 0, lineHeight: 1 }}>{s.value}</p>
                <p style={{ fontSize: 12, color: "#000000", margin: "4px 0 6px", fontWeight: 600 }}>{s.label}</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div style={{ ...CARD, overflow: "hidden" }}>
          ...
          <div style={{ padding: "4px 18px 18px" }}>
            <p style={{ fontSize: 11, color: "#000000", margin: "0 0 2px", fontWeight: 600, textTransform: "uppercase", letterSpacing: "0.05em" }}>Today&apos;s Overview</p>
            <h3 style={{ fontSize: 16, fontWeight: 800, color: "#111827", margin: "0 0 8px" }}>{adminName}</h3>
            <p style={{ fontSize: 11, color: "#000000", margin: 0, lineHeight: 1.6 }}>
        ...
        <div style={{ ...CARD, padding: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 10, color: "#000000", margin: 0, fontWeight: 600 }}>All tasks overview</p>
            </div>
          </div>
        ...
        <div style={{ ...CARD, padding: 20 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 10, color: "#000000", margin: 0, fontWeight: 600 }}>Approved leaves</p>
            </div>
          </div>
          <MiniCalendar
        ...
        <div style={{ ...CARD, padding: 20 }}>
          ...
          {notUpdatedYesterdayNames.length === 0 ? (
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "28px 0", gap: 8 }}>
              ...
              <p style={{ fontSize: 13, color: "#000000", margin: 0, fontWeight: 600 }}>Everyone submitted yesterday</p>
            </div>
          ) : (
        ...
        <div style={{ ...CARD, padding: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div style={{ padding: "14px 16px", borderRadius: 12, background: "rgba(99,102,241,0.06)", border: "1px solid rgba(99,102,241,0.15)" }}>
              ...
              <p style={{ fontSize: 11, color: "#000000", margin: "4px 0 0", fontWeight: 600 }}>Collaborative sessions today</p>
            </div>
            <div style={{ display: "flex", gap: 8 }}>
              <div style={{ flex: 1, padding: "10px 12px", borderRadius: 10, background: "#F9FAFB", border: "1px solid #E5E7EB" }}>
                ...
                <p style={{ fontSize: 10, color: "#000000", margin: "2px 0 0", fontWeight: 600 }}>This month</p>
              </div>
              <div style={{ flex: 1, padding: "10px 12px", borderRadius: 10, background: "#F9FAFB", border: "1px solid #E5E7EB" }}>
                <p style={{ fontSize: 18, fontWeight: 900, color: "#111827", margin: 0 }}>{totalTagsMonth}</p>
                <p style={{ fontSize: 10, color: "#000000", margin: "2px 0 0", fontWeight: 600 }}>Member tags</p>
              </div>
            </div>
              ...
              return (
                <div key={l.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 14px", borderRadius: 12, background: "#F9FAFB", border: "1px solid #E5E7EB" }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <p style={{ fontSize: 11, color: "#000000", margin: "2px 0 0", fontWeight: 600 }}>{empId}</p>
                  </div>
