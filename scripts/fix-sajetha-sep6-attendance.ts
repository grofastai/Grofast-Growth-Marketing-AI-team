// Backfill Sajetha SK (GF003) Sep 6, 2026: she worked in the office 09:30 - 19:00 IST
// with a 13:30-14:30 lunch break, but never clocked in — no attendance_logs row existed
// for the date at all. Insert the session so her attendance/payroll reflects the day.
// Run: npx tsx scripts/fix-sajetha-sep6-attendance.ts
...
const CLOCK_IN_ISO  = new Date(`${DATE}T09:30:00+05:30`).toISOString()
const CLOCK_OUT_ISO = new Date(`${DATE}T19:00:00+05:30`).toISOString()
const BREAK_SESSIONS = [{ label: 'Lunch Break', start: '13:30', end: '14:30', duration_mins: 60 }]
const BREAK_TOTAL_MINS = 60
...
async function main() {
  ...
  console.log(`${DATE}: 09:30-19:00 IST, office, present, 60 min lunch break -> 8.5h working hours`)
}
