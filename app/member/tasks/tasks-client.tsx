      ...
      <div className="flex-1 min-w-0 overflow-auto p-4 md:p-5 xl:p-6">
        ...
        <div style={{
          ...
          {/* LEFT: badge + title + subtitle — paddingRight reserves space so the title/subtitle never
              run under the absolutely-positioned illustration on the right (illustration + its right
              offset both scale with the same clamp() formula, so this stays matched at every width) */}
          <div style={{ flex: 1, position: "relative", zIndex: 3, paddingTop: 24, paddingBottom: 24, paddingRight: "clamp(90px,30vw,260px)" }}>
