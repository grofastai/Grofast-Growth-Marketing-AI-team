    ...
    <div className="rounded-2xl p-5 h-full" style={{ background: "#FFFFFF", border: "1px solid #E5E7EB", boxShadow: "0 1px 2px rgba(0,0,0,0.04), 0 4px 12px rgba(0,0,0,0.04)" }}>
      ...
      {leaves.length === 0 ? (
        <div className="flex flex-col items-center py-10 gap-2">
          ...
          <p className="text-[13px]" style={{ color: "#1b365d" }}>No pending leave requests</p>
        </div>
      ) : (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-[13px] font-semibold leading-tight" style={{ color: "#111827" }}>
                      {member?.name ?? "—"}
                      <span className="ml-1.5 text-[11px] font-medium" style={{ color: "#1b365d" }}>
                        #{member?.employee_id}
                      </span>
                    </p>
                    <p className="text-[11px] mt-0.5 truncate" style={{ color: "#1b365d" }}>
