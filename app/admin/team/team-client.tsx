          ...
          <div className="flex items-center gap-3">
            {!isEdit && step === "details" && (
              <button onClick={() => { setStep("type"); setError(""); setWhatsappWarning("") }}
                ...
                <ChevronDown size={13} style={{ color: "#000000", transform: "rotate(90deg)" }} />
              </button>
            )}
            <div>
              ...
              <p className="text-[12px] mt-0.5" style={{ color: "#000000" }}>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-5">
                ...
                return (
                  <button key={type.role} type="button"
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[12px] mt-0.5" style={{ color: "#000000" }}>{type.desc}</p>
                    </div>
                    <ChevronDown size={14} style={{ color: "#000000", transform: "rotate(-90deg)", flexShrink: 0 }} />
                  </button>
                )
              })}
            </div>
          ...
          {(isEdit || step === "details") && (
            <>
              ...
              {isEdit && (
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Passport Photo</label>
                  <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                    <div style={{ width: 64, height: 80, borderRadius: 10, overflow: "hidden", flexShrink: 0, border: "2px solid #E5E7EB", background: "#F9FAFB", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      {(photoPreview ?? member?.passport_photo_url) ? (
                        ...
                        <User size={22} style={{ color: "#000000" }} />
                      )}
                    </div>
                    <label style={{ flex: 1, cursor: "pointer" }}>
                      <div style={{ padding: "12px", borderRadius: 10, border: "1.5px dashed #E5E7EB", background: "#FAFAFA", textAlign: "center" }}>
                        <Camera size={16} style={{ color: "#000000", margin: "0 auto 5px" }} />
                        <p style={{ fontSize: 12, fontWeight: 600, color: "#000000" }}>{(photoPreview ?? member?.passport_photo_url) ? "Change Photo" : "Upload Photo"}</p>
                        <p style={{ fontSize: 10, color: "#000000", marginTop: 2 }}>JPG or PNG · Max 2MB</p>
                      </div>
              ...
              {(isFreelancerMgr && !isEdit) || (isAdmin && !isEdit) ? (
                <>
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Email Address *</label>
                    <input type="email" className="sheet-input" value={form.email} onChange={set("email")} placeholder="e.g. manager@gmail.com" style={FIELD} />
                    <p className="text-[11px] mt-1.5" style={{ color: "#000000" }}>Logs in with this email + password directly.</p>
                  </div>
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Password *</label>
                ...
                <>
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Name *</label>
                ...
                <>
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Gmail Address *</label>
                    <input type="email" className="sheet-input" value={form.email} onChange={set("email")} placeholder="e.g. admin@gmail.com" style={FIELD} />
                    <p className="text-[11px] mt-1.5" style={{ color: "#000000" }}>Admin logs in with this Gmail + password directly.</p>
                  </div>
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Password *</label>
                    <input type="text" className="sheet-input" value={form.password} onChange={set("password")} placeholder="Min 6 characters" style={FIELD} />
                ...
                <>
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Employment Type *</label>
                      ...
                      {([
                        ...
                        <button key={value} type="button"
                          ...
                          style={form.employment_type === value
                            ...
                            : { background: "rgba(0,0,0,0.03)", color: "#000000", border: "1px solid #E5E7EB" }}>
                          {label}
                        </button>
                      ))}
                    </div>
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Team *</label>
                    <div className="relative">
                      ...
                      <ChevronDown size={13} className="absolute right-3.5 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: "#000000" }} />
                    </div>
                    {isNoLoginTeam && (
                  ...
                  {!isNoLoginTeam && form.team && (() => {
                    ...
                    return (
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Layout *</label>
                        ...
                        {layoutOptions.map(({ value, label }) => (
                          <button key={value} type="button"
                            ...
                            style={{
                              ...
                              color: form.work_layout === value ? "#DE1A1A" : "#000000",
                            }}>
                            {label}
                          </button>
                        ))}
                  ...
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Full Name *</label>
                    <input className="sheet-input" value={form.name} onChange={set("name")} placeholder="e.g. Priya Sharma" style={FIELD} />
                  </div>

                  {/* Gender — always shown */}
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Gender *</label>
                      ...
                      {(["male", "female"] as const).map(g => (
                        <button key={g} type="button" onClick={() => setForm(p => ({ ...p, gender: g }))}
                          style={{ flex: 1, padding: "10px 0", borderRadius: 10, fontSize: 13, fontWeight: 700, border: "1.5px solid", cursor: "pointer", transition: "all 0.15s",
                            ...
                            color: form.gender === g ? (g === "male" ? "#2563EB" : "#DB2777") : "#000000",
                          }}>
                          {g === "male" ? "👦 Male" : "👧 Female"}
                        </button>
                      ))}
                  ...
                  {/* Phone — always shown */}
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>WhatsApp Number</label>
                    <input className="sheet-input" value={form.phone} onChange={set("phone")} placeholder="e.g. 919876543210" style={FIELD} />
                    {!isNoLoginTeam && <p className="text-[11px] mt-1.5" style={{ color: "#000000" }}>Credentials will be sent here after account creation.</p>}
                  </div>

                  {/* Position — shown for all (full time + login + no-login) */}
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Position / Designation</label>
                  ...
                  {!isNoLoginTeam && !isEdit && (
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>
                      ...
                      <p className="text-[11px] mt-1.5" style={{ color: "#000000" }}>Auto-filled — you can change it. Cannot be edited after creation.</p>
                    </div>
                  )}
                  ...
                  {!isNoLoginTeam && form.employment_type === "regular" && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      <div>
                        <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Monthly Salary (₹)</label>
                      ...
                      <div>
                        <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Paid Leave/Month</label>
                  ...
                  <div className={isNoLoginTeam ? "" : "grid grid-cols-1 md:grid-cols-2 gap-3"}>
                    {!isNoLoginTeam && (
                      <div>
                        <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Date of Birth</label>
                    ...
                    <div>
                      <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-2" style={{ color: "#000000" }}>Work Start Date</label>
                  ...
                  {!isNoLoginTeam && !isEdit && (
                    <div>
                      ...
                      <input type="text" className="sheet-input" value={form.password} onChange={set("password")} placeholder="Min 6 characters" style={FIELD} />
                      {!isAdmin && <p className="text-[11px] mt-1.5" style={{ color: "#000000" }}>Will be sent via WhatsApp.</p>}
                    </div>
                  )}
                </>
              )}
              ...
              {!isNoLoginTeam && form.role === "MEMBER" && (
                <div
                  ...
                  <div>
                    <p style={{ fontSize: 13, fontWeight: 700, color: form.is_management ? "#6366F1" : "#000000", margin: 0 }}>
                      Management Member
                    </p>
        ...
        {(isEdit || step === "details") && (
          <div className="px-6 py-4 flex items-center gap-3 flex-shrink-0" style={{ borderTop: "1px solid #E5E7EB" }}>
            <button onClick={onClose}
              ...
              style={{ background: "rgba(0,0,0,0.03)", color: "#000000", border: "1px solid #E5E7EB" }}>
        ...
        <div className="w-full max-w-[420px] rounded-2xl shadow-2xl flex flex-col"
          ...
          {success ? (
            <div className="px-6 py-8 flex flex-col items-center gap-4 text-center">
              ...
              <div>
                ...
                {success.whatsappSent ? (
                  ...
                  <p className="text-[12px] mt-1.5" style={{ color: "#000000" }}>
              ...
              <button onClick={onClose} className="mt-2 px-6 py-2.5 rounded-xl text-[13px] font-semibold"
                style={{ background: "rgba(0,0,0,0.04)", color: "#000000", border: "1px solid #E5E7EB" }}>
                Done
              </button>
            </div>
          ) : (
            <div className="px-6 py-5 space-y-4">
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-1.5" style={{ color: "#000000" }}>Task Title *</label>
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-1.5" style={{ color: "#000000" }}>Description <span style={{ color: "#000000", fontWeight: 600 }}>(optional)</span></label>
              ...
              <div>
                <label className="block text-[10px] font-bold uppercase tracking-[0.18em] mb-1.5" style={{ color: "#000000" }}>Due Date <span style={{ color: "#000000", fontWeight: 600 }}>(optional)</span></label>
    ...
    <div className="fixed inset-0 z-50 flex">
      ...
      <div className="relative ml-auto h-full w-full max-w-[420px] bg-white shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          ...
          <button onClick={close} className="w-8 h-8 rounded-full flex items-center justify-center text-black font-semibold hover:text-gray-600 hover:bg-gray-100 transition-all">
            <X size={16} />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {success ? (
            <div className="flex flex-col items-center justify-center h-full gap-4 text-center">
              ...
              <p className="text-[13px] text-black font-semibold">{name} has been added. Manager can now enter their work.</p>
            ...
            <div className="flex flex-col gap-4">
              <p className="text-[13px] text-black font-semibold">Select freelancer type to continue</p>
            ...
            <form id="fl-quick-form" onSubmit={handleSubmit} className="flex flex-col gap-4">
              <button type="button" onClick={() => setStep("type")}
                className="flex items-center gap-1.5 text-[12px] font-semibold text-black font-semibold hover:text-gray-600 -mt-1">
                ← Change type
              </button>

              <div>
                <label className="block text-[11px] font-semibold uppercase tracking-wider text-black font-semibold mb-1.5">Full Name *</label>
                <input className={FIELD_CLS} placeholder="e.g. Ravi Kumar" value={name} onChange={e => setName(e.target.value)} />
              </div>

              <div>
                <label className="block text-[11px] font-semibold uppercase tracking-wider text-black font-semibold mb-2">Gender</label>
                <div className="flex gap-2">
                  {["male","female"].map(g => (
                    <button key={g} type="button"
                      onClick={() => setGender(gender === g ? "" : g)}
                      className="flex-1 py-2.5 rounded-xl text-[13px] font-bold capitalize transition-all"
                      style={gender === g ? { background: "#F97316", color: "#fff", border: "2px solid #F97316" } : { background: "#F9FAFB", color: "#000000", border: "2px solid #E5E7EB" }}>
                      {g === "male" ? "Male" : "Female"}
                    </button>
                  ))}
                </div>
              ...
              <div>
                <label className="block text-[11px] font-semibold uppercase tracking-wider text-black font-semibold mb-1.5">Phone</label>
    ...
    <div className="fixed inset-0 z-50 flex">
      ...
      <div className="relative ml-auto h-full w-full max-w-[420px] bg-white shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          ...
          <button onClick={onClose} className="w-8 h-8 rounded-full flex items-center justify-center text-black font-semibold hover:text-gray-600 hover:bg-gray-100 transition-all">
            <X size={16} />
          </button>
        </div>
        <form id="fl-edit-form" onSubmit={handleSave} className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
          {/* Team picker */}
          <div>
            <label className="block text-[11px] font-semibold uppercase tracking-wider text-black font-semibold mb-2">Team *</label>
            <div className="grid grid-cols-3 gap-2">
              {NO_LOGIN_FL_TYPES.map(t => (
                <button key={t.key} type="button" onClick={() => setTeam(t.key)}
                  ...
                  <span className="text-[10px] font-bold leading-tight" style={{ color: team === t.key ? "#fff" : "#000000" }}>{t.label}</span>
                </button>
              ))}
            </div>
          </div>
          ...
          {/* Status */}
          <div>
            <label className="block text-[11px] font-semibold uppercase tracking-wider text-black font-semibold mb-2">Status</label>
            <div className="flex gap-2">
              {(["active", "inactive"] as const).map(s => (
                <button key={s} type="button" onClick={() => setStatus(s)}
                  ...
                  style={status === s
                    ...
                    : { background: "#F9FAFB", color: "#000000", border: "2px solid #E5E7EB" }}>
      ...
      <div className="relative ml-auto h-full w-full max-w-[420px] bg-white shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div>
            ...
            <p className="text-[12px] text-black font-semibold mt-0.5">Select who manages all freelancers</p>
          </div>
          <button onClick={close}
            className="w-8 h-8 rounded-full flex items-center justify-center text-black font-semibold hover:text-gray-600 hover:bg-gray-100 transition-all">
            <X size={16} />
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
          ...
          {/* ── Currently Assigned ── */}
          <div>
            <p className="text-[11px] font-bold uppercase tracking-wider text-black font-semibold mb-2">
              Currently Assigned <span className="normal-case font-normal text-black font-semibold">({assignedMembers.length})</span>
            </p>
            {assignedMembers.length === 0 ? (
              <p className="text-[12px] text-black font-semibold italic px-1">No managers assigned yet.</p>
            ) : (
                ...
                {assignedMembers.map(m => (
                  <div key={m.id}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[11px] text-black font-semibold">{m.employee_id} · {m.role}</p>
                    </div>
                    <button
          ...
          <div>
            <p className="text-[11px] font-bold uppercase tracking-wider text-black font-semibold mb-2">
              Add Manager <span className="normal-case font-normal text-black font-semibold">({selected.length} selected)</span>
            </p>
            {availableMembers.length === 0 ? (
              <p className="text-[12px] text-black font-semibold italic px-1">All members are already assigned.</p>
            ) : (
              <div className="flex flex-col gap-1.5">
          ...
          return (
            <div key={s.label}
              ...
              <div style={{ position: "relative", zIndex: 1 }} className="max-w-[52%] sm:max-w-[60%] lg:max-w-[55%]">
                ...
                <p className="text-[11px] mt-1.5 font-medium" style={{ color: "#000000" }}>{s.sub}</p>
              </div>
            </div>
          )
        })}
          ...
          return (
            <div
              ...
              <div style={{ position: "relative", zIndex: 1 }} className="max-w-[52%] sm:max-w-[60%] lg:max-w-[55%]">
                ...
                <p className="text-[11px] mt-1.5 font-medium" style={{ color: "#000000" }}>Freelance team</p>
              </div>
            </div>
          )
        })()}
        ...
        <div style={{ background: "#FFFFFF", border: "1px solid #E5E7EB", borderRadius: 18, overflow: "hidden" }}>
            ...
            <>
              ...
              <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
                <div>
                  ...
                  <p className="text-[12px]" style={{ color: "#000000" }}>{freelancers.length + loginFreelancerMembers.length} freelancer{freelancers.length + loginFreelancerMembers.length !== 1 ? "s" : ""}</p>
                </div>
                <button
                    ...
                    <thead>
                      <tr style={{ borderBottom: "1px solid #F9FAFB", background: "#FAFAFA" }}>
                        {["Member", "Team", "Phone", "Status", "Actions"].map(h => (
                          <th key={h} className="text-left px-5 py-2.5 text-[10px] font-bold uppercase tracking-[0.16em]" style={{ color: "#000000" }}>{h}</th>
                        ))}
                      </tr>
                    </thead>
                    <tbody>
                            ...
                            <td className="px-5 py-3">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-[11px]" style={{ color: "#000000" }}>{m.employee_id}</p>
                                </div>
                              </div>
                            </td>
                            <td className="px-5 py-3 text-[12px]" style={{ color: "#000000", whiteSpace: "nowrap" }}>{m.team ?? "—"}</td>
                            <td className="px-5 py-3 text-[13px]" style={{ color: "#000000" }}>{m.phone ?? "—"}</td>
                            <td className="px-5 py-3">
                              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-semibold"
                                style={m.status === "active" ? { background: "rgba(34,197,94,0.1)", color: "#16A34A" } : { background: "rgba(107,114,128,0.1)", color: "#000000" }}>
              ...
              {loginFreelancerMembers.length > 0 && freelancers.length > 0 && (
                <div className="px-5 py-2.5" style={{ background: "#FAFAFA", borderBottom: "1px solid #F3F4F6" }}>
                  <p className="text-[11px] font-bold uppercase tracking-[0.12em]" style={{ color: "#000000" }}>No-Login Freelancers</p>
                </div>
              )}
                  ...
                  <thead>
                    <tr style={{ borderBottom: "1px solid #F3F4F6", background: "#FAFAFA" }}>
                      {["Freelancer", "Team", "Phone", "Status", "Added", "Actions"].map(h => (
                        <th key={h} className="text-left px-5 py-3 text-[10px] font-bold uppercase tracking-[0.16em]" style={{ color: "#000000" }}>{h}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody>
                    {freelancers.length === 0 ? (
                      <tr><td colSpan={6} className="px-5 py-10 text-center text-[13px]" style={{ color: "#000000" }}>
                      ...
                      return (
                        <tr key={f.id} style={{ borderBottom: i < freelancers.length - 1 ? "1px solid #F9FAFB" : "none" }}>
                          <td className="px-5 py-3.5">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                {f.gender && <p className="text-[11px] capitalize" style={{ color: "#000000" }}>{f.gender}</p>}
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="px-5 py-3.5 text-[13px]" style={{ color: "#000000" }}>{f.phone ?? "—"}</td>
                          <td className="px-5 py-3.5">
                            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-semibold"
                              style={f.status === "active" ? { background: "rgba(34,197,94,0.1)", color: "#16A34A" } : { background: "rgba(107,114,128,0.1)", color: "#000000" }}>
                              <span className="w-1.5 h-1.5 rounded-full inline-block" style={{ background: f.status === "active" ? "#16A34A" : "#9CA3AF" }} />
                              {f.status === "active" ? "Active" : "Inactive"}
                            </span>
                          </td>
                          <td className="px-5 py-3.5 text-[12px]" style={{ color: "#000000" }}>{added}</td>
                          <td className="px-5 py-3.5">
          ...
          <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: "1px solid #F3F4F6" }}>
            <div>
              ...
              <p className="text-[12px]" style={{ color: "#000000" }}>{filtered.length} of {regularMembers.length} members</p>
            </div>
            <div className="flex items-center gap-2">
            {/* Tab filters */}
                    ...
                    <tr key={member.id}
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] mt-0.5" style={{ color: "#000000" }}>{member.position ?? member.email ?? "—"}</p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-5 py-3.5">
                        {["ADMIN","FOUNDER","CEO"].includes(member.role) ? (
                          ...
                          <span className="text-[11px] font-mono font-semibold px-2.5 py-1 rounded-lg" style={{ background: "#F3F4F6", color: "#000000" }}>{member.employee_id}</span>
                        )}
                      </td>
                        ...
                        <span className="inline-flex items-center gap-1.5 text-[11px] font-semibold px-2.5 py-1 rounded-full"
                          style={
                            ["ADMIN","FOUNDER","CEO"].includes(member.role)
                              ...
                              : { background: "rgba(0,0,0,0.04)", color: "#000000", border: "1px solid #E5E7EB" }
                          }>
                          <Shield size={9} />
                      ...
                      <td className="px-5 py-3.5">
                        <div className="flex items-center gap-1.5">
                          <CalendarDays size={10} style={{ color: "#000000" }} />
                          <span className="text-[12px]" style={{ color: "#000000" }}>{formatDate(member.joined_at ?? member.created_at)}</span>
                        </div>
                      </td>
                  ...
                  <tr>
                    <td colSpan={7} className="px-5 py-16 text-center">
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <p className="text-[13px] font-medium" style={{ color: "#000000" }}>No members found</p>
                        <p className="text-[12px]" style={{ color: "#000000" }}>Try adjusting your search or filters</p>
                      </div>
                    </td>
                  </tr>
                )}
          ...
          <div style={{ background: "#FFFFFF", border: "1px solid #E5E7EB", borderRadius: 18, overflow: "hidden" }}>
            <div className="px-5 py-4 flex items-center justify-between" style={{ borderBottom: "1px solid #F3F4F6" }}>
              <div>
                ...
                <p className="text-[11px]" style={{ color: "#000000" }}>Recent additions</p>
              </div>
            ...
            <div className="px-5 py-3 space-y-3">
              {recentActivity.length === 0 ? (
                <p className="text-center text-[12px] py-6" style={{ color: "#000000" }}>No team members yet</p>
              ) : (
                  ...
                  return (
                    <div key={m.id} className="flex items-center gap-3 py-1">
                      ...
                      <div className="text-right flex-shrink-0">
                        <p className="text-[10px]" style={{ color: "#000000" }}>{formatDateShort(m.joined_at ?? m.created_at)}</p>
      ...
      {pastMembers.length > 0 && (
        <div>
          <button onClick={() => setShowPast(v => !v)}
            ...
            Past Members
            <span className="text-[11px] px-2 py-0.5 rounded-full" style={{ background: "#F3F4F6", color: "#000000" }}>
              {pastMembers.length}
            </span>
          </button>
                    ...
                    <tr key={m.id} style={{ borderBottom: i < pastMembers.length - 1 ? "1px solid #F9FAFB" : "none", opacity: 0.65 }}>
                      <td className="px-5 py-3">
                        <div className="flex items-center gap-3">
                          <div className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0"
                            style={{ background: "#F3F4F6" }}>
                            <span className="text-[10px] font-bold" style={{ color: "#000000" }}>{getInitials(m.name)}</span>
                          </div>
                          <div>
                            <p className="text-[13px] font-semibold" style={{ color: "#000000" }}>{m.name}</p>
                            <p className="text-[11px]" style={{ color: "#000000" }}>{m.email ?? "—"}</p>
                          </div>
                        </div>
                      </td>
                      <td className="px-5 py-3"><span className="text-[12px] font-mono px-2 py-0.5 rounded" style={{ background: "#F3F4F6", color: "#000000" }}>{m.employee_id}</span></td>
                      <td className="px-5 py-3"><span className="text-[12px]" style={{ color: "#000000" }}>{m.team ?? "—"}</span></td>
                      <td className="px-5 py-3"><span className="text-[11px] px-2 py-0.5 rounded-full" style={{ background: "#F3F4F6", color: "#000000" }}>{m.role}</span></td>
                      <td className="px-5 py-3"><span className="text-[12px]" style={{ color: "#000000" }}>{m.deleted_at ? formatDate(m.deleted_at) : "—"}</span></td>
                      <td className="px-5 py-3">
                        ...
                        <td className="px-5 py-3">
                          <div className="flex items-center gap-3">
                            <div style={{ width: 32, height: 32, borderRadius: 9, background: "#F3F4F6", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                              <span style={{ fontSize: 11, fontWeight: 800, color: "#000000" }}>{initials}</span>
                            </div>
                            <div>
                              <p className="text-[13px] font-semibold" style={{ color: "#000000" }}>{f.name}</p>
                              {f.gender && <p className="text-[11px] capitalize" style={{ color: "#000000" }}>{f.gender}</p>}
                            </div>
                          </div>
                        </td>
                        <td className="px-5 py-3">
                          <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-[10px] font-semibold" style={{ background: "#F3F4F6", color: "#000000" }}>
                            {teamCfg.emoji} {teamCfg.label}
                          </span>
                        </td>
                        <td className="px-5 py-3 text-[12px]" style={{ color: "#000000" }}>{f.phone ?? "—"}</td>
                        <td className="px-5 py-3 text-[12px]" style={{ color: "#000000" }}>
            ...
            <div className="w-full max-w-[380px] rounded-2xl shadow-2xl flex flex-col"
              ...
              <div className="px-6 pt-6 pb-4 flex flex-col items-center text-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[13px] mt-1.5 leading-relaxed" style={{ color: "#000000" }}>
            ...
            <div className="w-full max-w-[380px] rounded-2xl shadow-2xl"
              ...
              <div className="px-6 pt-6 pb-4 flex flex-col items-center text-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[13px] mt-1" style={{ color: "#000000" }}>
              ...
              {resetSuccess ? (
                ...
                <div className="px-6 pb-6 space-y-4">
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-[0.15em] mb-1.5" style={{ color: "#000000" }}>New Password</label>
