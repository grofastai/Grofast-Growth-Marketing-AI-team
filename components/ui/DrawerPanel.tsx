...
// + a flat solid panel sliding in from the right (no blur, no translucency).
// `header` is rendered above a close button (e.g. a SegmentedControl),
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end"
      ...
      >
        ...
        <div className="flex items-center gap-3 px-5 py-4 flex-shrink-0" style={{ borderBottom: "1px solid #EDEDED" }}>
