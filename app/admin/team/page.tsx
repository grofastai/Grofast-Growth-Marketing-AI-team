...
export default async function TeamPage() {
  ...
  const [{ data: members, error: membersError }, { data: pastMembers }] = await Promise.all([
    admin
      .from('users')
      .select('id, name, employee_id, role, email, phone, status, team, created_at, employment_type, monthly_salary, hourly_rate, paid_leave_days, deleted_at, date_of_birth, joined_at')
