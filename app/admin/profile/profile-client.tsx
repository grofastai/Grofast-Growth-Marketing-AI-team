  ...
  return (
    <div>
      ...
      <button onClick={() => ref.current?.click()} disabled={loading}
        style={{ width: "100%", display: "flex", alignItems: "center", justifyContent: "center", gap: 6, padding: "10px", borderRadius: 10, border: `1.5px dashed ${url ? "#16A34A" : "#EBEDF2"}`, background: url ? "rgba(34,197,94,0.04)" : "#F8F9FC", fontSize: 11, fontWeight: 600, color: url ? "#16A34A" : "#4E0535", cursor: "pointer" }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-[18px] items-start">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: 18, marginBottom: 20 }}>
              ...
              <div style={{ position: "relative", flexShrink: 0 }}>
                ...
                <button onClick={() => setShowPicker(true)} disabled={photoBusy}
                  ...
                  {photoBusy ? <Loader2 size={11} style={{ color: "#4E0535", animation: "spin 1s linear infinite" }} /> : <Camera size={11} style={{ color: "#4E0535" }} />}
                </button>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    ...
                    <div style={{ display: "flex", gap: 8 }}>
                      ...
                      <button onClick={() => { setEditing(false); setEditName(profile?.name ?? ""); setEditPhone(profile?.phone ?? "") }}
                        style={{ display: "flex", alignItems: "center", gap: 5, padding: "8px 14px", borderRadius: 10, background: "#F5F6FA", border: "1px solid #EBEDF2", fontSize: 12, fontWeight: 700, color: "#4E0535", cursor: "pointer" }}>
                        <X size={11} /> Cancel
                      </button>
                    </div>
                  </div>
                  ...
                  <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between" }}>
                    <div>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                        ...
                        <span style={{ fontSize: 11, fontWeight: 700, padding: "4px 12px", borderRadius: 99, background: "#F5F6FA", color: "#4E0535", border: "1px solid #EBEDF2" }}>
                          #{profile?.employee_id ?? "—"}
                        </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={r.label} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 14px", borderRadius: 12, background: "#F9FAFB", border: "1px solid #EBEDF2" }}>
                  <span style={{ fontSize: 11, color: "#4E0535", fontWeight: 600 }}>{r.label}</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-[14px]">
            ...
            <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #EBEDF2", padding: "20px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <User size={16} style={{ color: "#4E0535" }} />
              ...
              {editPersonal ? (
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  <div>
                    <label style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", color: "#4E0535", display: "block", marginBottom: 7 }}>Blood Group</label>
                    <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                      {BLOOD_GROUPS.map(bg => (
                        <button key={bg} onClick={() => setPersonal(p => ({ ...p, blood_group: bg }))}
                          style={{ padding: "5px 12px", borderRadius: 8, fontSize: 11, fontWeight: 700, cursor: "pointer", border: "none", background: personal.blood_group === bg ? "#DE1A1A" : "#F5F6FA", color: personal.blood_group === bg ? "#fff" : "#4E0535" }}>
                          {bg}
                        </button>
                      ))}
                    </div>
                  ...
                  <div>
                    <label style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", color: "#4E0535", display: "block", marginBottom: 5 }}>Address</label>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                    <div>
                      <label style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "#4E0535", display: "block", marginBottom: 5 }}>Emergency Name</label>
                    ...
                    <div>
                      <label style={{ fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.08em", color: "#4E0535", display: "block", marginBottom: 5 }}>Emergency Phone</label>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    ...
                    <button onClick={() => setEditPersonal(false)}
                      style={{ display: "flex", alignItems: "center", gap: 5, padding: "9px 14px", borderRadius: 10, background: "#F5F6FA", border: "1px solid #EBEDF2", fontSize: 12, fontWeight: 700, color: "#4E0535", cursor: "pointer" }}>
                      <X size={11} /> Cancel
                    </button>
                  </div>
                </div>
                  ...
                  {[
                    ...
                    <div key={label} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                      <div style={{ width: 32, height: 32, borderRadius: 10, background: "#F8F9FC", border: "1px solid #EBEDF2", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1 }}>
                        <Icon size={13} style={{ color: value === "—" ? "#4E0535" : "#4E0535" }} />
                      </div>
                      <div>
                        <p style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.08em", color: "#4E0535", margin: "0 0 3px", fontWeight: 600 }}>{label}</p>
                        <p style={{ fontSize: 13, fontWeight: 600, color: value === "—" ? "#4E0535" : "#111111", margin: 0, lineHeight: 1.5 }}>{value}</p>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #EBEDF2", padding: "20px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <Landmark size={16} style={{ color: "#4E0535" }} />
              ...
              {editKYC ? (
                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  <div>
                    <p style={{ fontSize: 11, fontWeight: 700, color: "#4E0535", margin: "0 0 8px" }}>Bank Account</p>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 7 }}>
                    <div>
                      <label style={{ fontSize: 10, color: "#4E0535", fontWeight: 600, display: "block", marginBottom: 4 }}>Aadhaar No.</label>
                    ...
                    <div>
                      <label style={{ fontSize: 10, color: "#4E0535", fontWeight: 600, display: "block", marginBottom: 4 }}>PAN No.</label>
                  ...
                  {([
                    ...
                    <div key={sec.title}>
                      <p style={{ fontSize: 11, fontWeight: 700, color: "#4E0535", margin: "0 0 7px" }}>{sec.title}</p>
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 7 }}>
                        {sec.fields.map(({ f, l }) => (
                          <div key={f}>
                            <label style={{ fontSize: 9, color: "#4E0535", fontWeight: 600, display: "block", marginBottom: 4 }}>{l}</label>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  {[
                    ...
                    <div key={label} style={{ display: "flex", alignItems: "flex-start", gap: 12 }}>
                      ...
                      <div>
                        <p style={{ fontSize: 10, textTransform: "uppercase", letterSpacing: "0.08em", color: "#4E0535", margin: "0 0 3px", fontWeight: 600 }}>{label}</p>
                        <p style={{ fontSize: 13, fontWeight: 600, color: value === "—" ? "#4E0535" : "#111111", margin: 0 }}>{value}</p>
                      </div>
                    </div>
                  ))}
                  <button style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, width: "100%", padding: "11px", borderRadius: 12, background: "#F8F9FC", border: "1.5px solid #EBEDF2", fontSize: 12, fontWeight: 700, color: "#4E0535", cursor: "pointer", marginTop: 4 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #EBEDF2", padding: "20px 22px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }}>
              <Settings size={16} style={{ color: "#4E0535" }} />
              <span style={{ fontSize: 14, fontWeight: 800, color: "#111111" }}>Account Actions</span>
            </div>
            <p style={{ fontSize: 12, color: "#4E0535", margin: "0 0 16px" }}>Manage your account security and preferences</p>
              ...
              {[
                ...
                <button key={title} onClick={action}
                  ...
                  <div style={{ width: 38, height: 38, borderRadius: 11, background: "#fff", border: "1px solid #EBEDF2", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <Icon size={15} style={{ color: "#4E0535" }} />
                  </div>
                  <div style={{ flex: 1 }}>
                    <p style={{ fontSize: 13, fontWeight: 700, color: "#111111", margin: "0 0 2px" }}>{title}</p>
                    <p style={{ fontSize: 10, color: "#4E0535", margin: 0 }}>{desc}</p>
                  </div>
                  <ChevronRight size={13} style={{ color: "#4E0535", flexShrink: 0 }} />
                </button>
              ))}
            </div>
            <button onClick={() => startLogout(async () => { await logoutAction() })} disabled={logoutPending}
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: 10, color: "#4E0535", margin: 0 }}>End your current session</p>
              </div>
              <ChevronRight size={13} style={{ color: "#4E0535" }} />
            </button>
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {[
                ...
                <div key={label} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <p style={{ flex: 1, fontSize: 12, color: "#4E0535", margin: 0 }}>{label}</p>
          ...
          <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #EBEDF2", padding: "20px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
            ...
            <p style={{ fontSize: 11, color: "#4E0535", margin: "0 0 14px" }}>Click any photo to set as profile picture</p>
            ...
            <label style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 7, marginTop: 12, padding: "10px", borderRadius: 12, background: "#F9FAFB", border: "1.5px dashed #EBEDF2", cursor: "pointer", fontSize: 12, fontWeight: 600, color: "#4E0535" }}>
          ...
          <div style={{ position: "relative", background: "#fff", borderRadius: 24, padding: 24, width: "100%", maxWidth: 480, boxShadow: "0 24px 64px rgba(0,0,0,0.18)" }}
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18 }}>
              <div>
                ...
                <p style={{ fontSize: 12, color: "#4E0535", margin: "3px 0 0" }}>Select from our collection or upload your own</p>
              </div>
            ...
            <label style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, width: "100%", padding: "11px", borderRadius: 12, background: "#F8F9FC", border: "2px dashed #D1D5DB", cursor: "pointer", fontSize: 13, fontWeight: 600, color: "#4E0535" }}>
