# Admin Support Page Redesign Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Redesign `app/admin/support/support-client.tsx` to match the provided mockup — hero banner with 3D boy illustration, stat cards with sparklines, searchable/sortable ticket table, and pagination.

**Architecture:** Pure client-side UI rewrite of a single file. Backend (`lib/actions/support.ts`) is unchanged. New image asset copied to `public/brand/`. All state (filter, search, sort, page, modals) lives in the root component; sub-components receive only what they need.

**Tech Stack:** Next.js 15 App Router, React 19, TypeScript, Tailwind CSS v4, Lucide React, Next/Image
...
|--------|------|----------------|
| Create | `public/brand/support-hero.png` | 3D boy illustration used in hero banner |
| Rewrite | `app/admin/support/support-client.tsx` | Complete UI — hero, stat cards, table, modals |

---

### Task 1: Copy brand asset to public/brand

**Files:**
- Create: `public/brand/support-hero.png`

- [ ] **Step 1: Copy the image**

```powershell
Copy-Item "s:\VS CODE USING CODEX\GROFAST GROWTH MARKETING AND AI SOLUTIOn\Brand Asset\47342571-ab39-4082-b5b9-08c00222b47f.png" `
  "s:\VS CODE USING CODEX\GROFAST GROWTH MARKETING AND AI SOLUTIOn\public\brand\support-hero.png"
```

Expected: no error, file exists at `public/brand/support-hero.png`

- [ ] **Step 2: Verify**

```powershell
Test-Path "s:\VS CODE USING CODEX\GROFAST GROWTH MARKETING AND AI SOLUTIOn\public\brand\support-hero.png"
```
...
```bash
git add public/brand/support-hero.png
git commit -m "feat: add support hero illustration to public/brand"
```

---

### Task 2: Rewrite admin support-client.tsx

**Files:**
- Rewrite: `app/admin/support/support-client.tsx`

- [ ] **Step 1: Replace the entire file with the new implementation**

Write the following to `app/admin/support/support-client.tsx`:
...
Expected: no errors referencing `support-client.tsx`
...
Open `http://localhost:3000/admin/support` and confirm:
- Hero banner with warm cream background and boy illustration
- "Let's solve it together ❤" text visible (desktop)
- 4 stat cards with sparklines
- "+ New Ticket" button opens modal
- Ticket table with all 7 columns
- Three-dot menu shows "View & Reply" and status actions
- Pagination renders at bottom

- [ ] **Step 4: Commit**

```bash
git add app/admin/support/support-client.tsx
git commit -m "feat: redesign admin support page with hero banner, stat cards, and ticket table"
```
