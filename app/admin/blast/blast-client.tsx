        ...
        <div className="flex flex-wrap gap-3 mb-5">
          ...
          {skippedCount > 0 && (
            <div className="flex items-center gap-2 px-4 py-2 rounded-lg"
              ...
              <Phone size={14} style={{ color: "#A10856" }} />
              <span className="text-[13px] font-medium" style={{ color: "#A10856" }}>
          ...
          {results.map(r => (
            <div key={r.userId} className="flex items-center gap-3 px-4 py-3 rounded-xl"
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-[11px] mt-0.5" style={{ color: "#A10856" }}>
              ...
              {r.status === "no_phone" && <Phone        size={16} style={{ color: "#A10856", flexShrink: 0 }} />}
            </div>
          ))}
        </div>
  ...
  return (
    <div className="p-4 md:p-6 xl:p-8 max-w-[1100px]">
      ...
      <div className="mb-7">
        ...
        <p className="text-sm mt-1" style={{ color: "#A10856" }}>
        ...
        <div className="space-y-5">
          ...
          <div className="rounded-xl p-5" style={{ background: "#FFFFFF", border: "1px solid #E5E7EB" }}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-[11px] font-bold uppercase tracking-[0.18em]" style={{ color: "#A10856" }}>Message</p>
            </div>
            <textarea
              value={message}
            ...
            />
            <p className="text-[11px] mt-1.5 text-right tabular-nums" style={{ color: "#A10856" }}>
              {message.length} / 1000
            </p>
          </div>
        ...
        <div className="rounded-xl p-5" style={{ background: "#FFFFFF", border: "1px solid #E5E7EB" }}>
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[11px] font-bold uppercase tracking-[0.18em]" style={{ color: "#A10856" }}>
                Recipients
              </p>
              {recipientCount > 0 && (
              ...
              return (
                <label key={m.id}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px]" style={{ color: m.phone ? "#A10856" : "#A10856" }}>
                      {m.phone ?? "No phone number"}
                    </p>
                  </div>
                  {!m.phone && <Phone size={11} style={{ color: "#A10856", flexShrink: 0 }} />}
                </label>
              )
            })}
          </div>
