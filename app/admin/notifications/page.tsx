...
function Section({ title, items }: { title: string; items: NotificationRow[] }) {
  ...
  return (
    <div style={{ marginBottom: 28 }}>
      <p style={{
        fontSize: 11, fontWeight: 800, color: "#7E0848",
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #EBEDF2' }} className="px-4 md:px-7 py-5">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            ...
            <p style={{ fontSize: 12, color: "#7E0848", margin: 0 }}>
        ...
        {!hasAny ? (
          <div style={{ textAlign: 'center', paddingTop: 80 }}>
            <div style={{ width: 72, height: 72, borderRadius: 24, background: '#F3F4F6', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
              <Bell size={32} style={{ color: "#7E0848" }} />
            </div>
            <p style={{ fontSize: 16, fontWeight: 800, color: "#7E0848", margin: '0 0 6px' }}>No notifications yet</p>
            <p style={{ fontSize: 13, color: "#7E0848", maxWidth: 280, margin: '0 auto' }}>
