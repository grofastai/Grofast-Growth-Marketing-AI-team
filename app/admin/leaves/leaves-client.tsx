    ...
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <p style={{ fontSize: 11, color: "#000000", margin: "1px 0 0" }}>{user?.employee_id ?? "—"}</p>
        </div>
        <span style={{
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <span style={{ fontSize: 11, fontWeight: 700, color: "#000000", background: "#F9FAFB", padding: "3px 10px", borderRadius: 8 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
        <CalendarDays size={13} style={{ color: "#000000", flexShrink: 0 }} />
        <span style={{ fontSize: 12, color: "#000000", fontWeight: 600 }}>{fmtRange(leave.from_date, leave.to_date)}</span>
      </div>

      {/* Reason */}
      <div style={{ display: "flex", alignItems: "flex-start", gap: 6 }}>
        <Paperclip size={12} style={{ color: "#000000", flexShrink: 0, marginTop: 2 }} />
        <p style={{
          fontSize: 12, color: "#000000", margin: 0, lineHeight: 1.45,
        ...
        <div style={{ minWidth: 0, display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "flex", gap: 6, overflowX: "auto", paddingBottom: 2, alignItems: "center", flexWrap: "wrap" }}>
            <div style={{ position: "relative", flexShrink: 0 }}>
              <select
                ...
                style={{
                  ...
                  color: mode !== "all" && mode !== "holidays" ? "#FFFFFF" : "#000000",
            ...
            <button onClick={() => navigateMode("holidays")} style={{
              ...
              color: mode === "holidays" ? "#FFFFFF" : "#000000",
              ...
              <>
                <div style={{ position: "relative", flexShrink: 0 }}>
                  <ListFilter size={12} strokeWidth={2.5}
                    style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", pointerEvents: "none", color: "#000000" }} />
                  <select
                    value={dateMode}
                    ...
                    style={{
                      ...
                      background: "#FFFFFF", color: "#000000", boxShadow: "0 1px 4px rgba(0,0,0,0.06)",
                    }}>
                  ...
                  <ChevronDown size={13} strokeWidth={2.5}
                    style={{ position: "absolute", right: 9, top: "50%", transform: "translateY(-50%)", pointerEvents: "none", color: "#000000" }} />
                </div>
                {dateMode === "month" && (
                  <div style={{ display: "flex", alignItems: "center", gap: 2, background: "#FFFFFF", borderRadius: 24, padding: "2px 6px", flexShrink: 0, boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
                    <button onClick={() => setFilterMonth(m => shiftMonth(m, -1))} aria-label="Previous month" style={{ width: 30, height: 30, border: "none", background: "transparent", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 8 }}><ChevronLeft size={15} color="#000000" /></button>
                    <span style={{ fontSize: 12, fontWeight: 700, color: "#000000", minWidth: 82, textAlign: "center", whiteSpace: "nowrap" }}>{monthLabel(filterMonth)}</span>
                    <button onClick={() => setFilterMonth(m => shiftMonth(m, 1))} aria-label="Next month" style={{ width: 30, height: 30, border: "none", background: "transparent", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", borderRadius: 8 }}><ChevronRight size={15} color="#000000" /></button>
                  </div>
                )}
                {dateMode === "custom" && (
                  <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
                    <input type="date" value={rangeFrom} onChange={e => setRangeFrom(e.target.value)} aria-label="From date"
                      style={{ padding: "7px 10px", borderRadius: 12, background: "#FFFFFF", border: "1px solid #EBEDF2", fontSize: 12, fontWeight: 600, color: "#000000", outline: "none", minHeight: 38 }} />
                    <span style={{ fontSize: 12, color: "#000000" }}>–</span>
              ...
              <div style={{ background:"#FFFFFF", borderRadius:18, border:"1px solid #EBEDF2", padding:"20px 22px", boxShadow:"0 2px 10px rgba(0,0,0,0.05)" }}>
                ...
                <div style={{ display:"flex", gap:10, flexWrap:"wrap", alignItems:"flex-end" }}>
                  <div style={{ display:"flex", flexDirection:"column", gap:5, flex:"0 0 160px" }}>
                    <label style={{ fontSize:10, fontWeight:700, color:"#000000", textTransform:"uppercase", letterSpacing:"0.08em" }}>Date</label>
                  ...
                  <div style={{ display:"flex", flexDirection:"column", gap:5, flex:1, minWidth:160 }}>
                    <label style={{ fontSize:10, fontWeight:700, color:"#000000", textTransform:"uppercase", letterSpacing:"0.08em" }}>Holiday Name</label>
              ...
              <div style={{ background:"#FFFFFF", borderRadius:18, border:"1px solid #EBEDF2", overflow:"hidden", boxShadow:"0 2px 10px rgba(0,0,0,0.05)" }}>
                ...
                {companyLeaves.length === 0 ? (
                  <div style={{ padding:"40px 24px", textAlign:"center" }}>
                    <p style={{ fontSize:14, color:"#000000", margin:0 }}>No holidays added yet.</p>
                  </div>
                ) : (
                  <div>
                      ...
                      return (
                        <div key={h.id} style={{ display:"flex", alignItems:"center", gap:12, padding:"12px 20px", borderBottom: borderStyle }}>
                          ...
                          <div style={{ flex:1, minWidth:0 }}>
                            ...
                            <p style={{ fontSize:11, color:"#000000", margin:"2px 0 0" }}>{dayName} · {dateFmt}</p>
                          </div>
          ...
          {mode !== "holidays" && (dateFilteredLeaves.length === 0 ? (
            <div style={{
              ...
              <p style={{ fontSize: 13, color: "#000000", margin: 0 }}>Your team is fully available today.</p>
            </div>
          ) : (
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 10, marginBottom: 18, flexWrap: "wrap" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 11, color: "#000000", margin: "2px 0 0" }}>Real-time team status overview</p>
                </div>
              </div>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 18, flexWrap: "wrap", gap: 8 }}>
              <p style={{ fontSize: 13, margin: 0 }}>
                ...
                <span style={{ color: "#000000", marginLeft: 6 }}>Members Available</span>
              </p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", position: "relative" }}>
              ...
              {[
                ...
                <div key={s.label} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, padding: "0 8px" }}>
                  ...
                  <p style={{ fontSize: 10, color: "#000000", margin: 0 }}>{pct(s.value)}%</p>
                </div>
              ))}
            </div>
