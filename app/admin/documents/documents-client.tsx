...
function VerifDonut({ pct }: { pct: number }) {
  ...
  return (
    <svg width={120} height={120} viewBox="0 0 120 120">
      ...
      <text x={60} y={72} textAnchor="middle" fontSize={9} fontWeight="600" fill="#000000">Profile Verified</text>
    </svg>
  )
}
  ...
  return (
    <div style={{
      ...
      <div className="flex items-start justify-between gap-2">
        <div>
          <p style={{ fontSize: 11, color: "#000000", fontWeight: 600, marginBottom: 3 }}>{label}</p>
          ...
          <div className="flex items-center gap-1 mt-1.5">
            ...
            <span style={{ fontSize: 10, color: "#000000" }}>vs last month</span>
          </div>
        </div>
        <div style={{
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-2 rounded-xl" style={{ background: "rgba(0,0,0,0.02)" }}>
      <div className="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0" style={{ background: "rgba(0,0,0,0.04)" }}>
        <Icon size={12} style={{ color: empty ? "#9CA3AF" : "#000000" }} />
      </div>
      <div className="flex-1 min-w-0">
        <p className="text-[10px] uppercase tracking-wider" style={{ color: "#000000" }}>{label}</p>
  ...
  return (
    <div style={{
      ...
      <div className="flex items-center justify-between">
        ...
        <div style={{ position: "relative" }}>
          <button onClick={() => setMenu(p => !p)} style={{ width: 28, height: 28, borderRadius: 8, background: "rgba(0,0,0,0.04)", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <MoreVertical size={13} style={{ color: "#000000" }} />
          </button>
          {menu && (
      ...
      <div>
        ...
        <p style={{ fontSize: 10, color: "#000000", marginTop: 2 }}>{formatDateShort(doc.created_at)}{doc.file_size ? ` · ${formatSize(doc.file_size)}` : ""}</p>
      </div>
      {/* Status + actions */}
      <div className="flex items-center justify-between">
        <span style={{
      ...
      <div className="flex gap-2">
        <a href={doc.file_url} target="_blank" rel="noopener noreferrer"
          style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 5, padding: "7px", borderRadius: 10, background: "rgba(0,0,0,0.04)", fontSize: 11, fontWeight: 600, color: "#000000", textDecoration: "none" }}>
          <Eye size={11} /> View
        </a>
        <a href={doc.file_url} download
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3 rounded-2xl"
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <p style={{ fontSize: 11, color: "#000000", marginTop: 2 }}>{formatDate(doc.created_at)}{doc.file_size ? ` · ${formatSize(doc.file_size)}` : ""}</p>
      </div>
      ...
      {uploadSuccess && (
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: 11, color: "#000000", margin: 0 }}>{uploadSuccess}</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[256px_1fr_288px] gap-3.5 px-4 md:px-5 pt-4">
        ...
        <div className="hidden lg:flex flex-col" style={{ background: "#fff", borderRadius: 20, border: "1px solid rgba(0,0,0,0.07)", boxShadow: "0 2px 12px rgba(0,0,0,0.05)", overflow: "hidden" }}>
          <div style={{ padding: "16px 16px 12px" }}>
            ...
            <div style={{ position: "relative" }}>
              <Search size={12} style={{ position: "absolute", left: 10, top: "50%", transform: "translateY(-50%)", color: "#000000" }} />
              <input
                ...
                <button key={m.id} onClick={() => { setSelectedId(m.id); setActiveTab("documents"); setDocFilter("All"); setDocSearch("") }}
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div className="flex items-center gap-1.5 mt-0.5">
                      <span style={{ fontSize: 9, fontWeight: 600, color: "#000000" }}>#{m.employee_id}</span>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4, flexShrink: 0 }}>
                    ...
                    <span style={{ fontSize: 10, fontWeight: 800, color: "#000000" }}>{mDocs}</span>
                    <span style={{ fontSize: 8, color: "#000000", marginTop: -3 }}>docs</span>
                  </div>
                </button>
              )
            })}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div className="lg:hidden" style={{ position: "relative" }}>
            <Users size={13} style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "#000000", pointerEvents: "none" }} />
            <select
              value={selectedId}
            ...
            <ChevronRight size={13} style={{ position: "absolute", right: 12, top: "50%", transform: "translateY(-50%) rotate(90deg)", color: "#000000", pointerEvents: "none" }} />
          </div>
          {selectedMember ? (
            <>
              {/* Profile header card */}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                        <span style={{ fontSize: 10, color: "#000000" }}>{selectedMember.employment_type ?? selectedMember.role}</span>
                        {selectedMember.team && (
                          <>
                        ...
                        <span style={{ fontSize: 10, color: "#000000" }}>•</span>
                        <span style={{ fontSize: 10, color: "#000000" }}>Joined {formatDate(selectedMember.created_at)}</span>
                      </div>
                    </div>
                    {/* Completion ring */}
                    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 2 }}>
                      <CompletionRing pct={completionPct} size={68} />
                      <p style={{ fontSize: 9, color: "#000000", fontWeight: 600 }}>Profile Complete</p>
                    </div>
                  </div>
                  {/* Action pills */}
                  <div className="flex gap-2 mt-4 flex-wrap">
                    {[
                      ...
                      <button key={a.label} onClick={a.onClick} style={{
                        ...
                        background: "rgba(0,0,0,0.03)", color: "#000000",
                  ...
                  {TABS.map(tab => (
                    <button key={tab.id} onClick={() => setActiveTab(tab.id)}
                      style={{
                        ...
                        color: activeTab === tab.id ? "#de1a1a" : "#000000",
                        transition: "all 0.15s",
                      }}>
                      {tab.label}
                    </button>
                ...
                <>
                  ...
                  <div style={{ background: "#fff", borderRadius: 16, border: "1px solid rgba(0,0,0,0.07)", padding: "12px 16px", display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
                    <div style={{ display: "flex", gap: 6, flex: 1, flexWrap: "wrap" }}>
                      {FILTER_CHIPS.map(chip => (
                        <button key={chip} onClick={() => setDocFilter(chip)} style={{
                          ...
                          color: docFilter === chip ? "#fff" : "#000000",
                        }}>{chip}</button>
                      ))}
                    </div>
                    {/* Search + view toggle */}
                    <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                      <div style={{ position: "relative" }}>
                        <Search size={11} style={{ position: "absolute", left: 9, top: "50%", transform: "translateY(-50%)", color: "#000000" }} />
                      ...
                      <button onClick={() => setViewMode("grid")} style={{ width: 30, height: 30, borderRadius: 8, border: "none", cursor: "pointer", background: viewMode === "grid" ? "#de1a1a" : "rgba(0,0,0,0.04)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <LayoutGrid size={13} style={{ color: viewMode === "grid" ? "#fff" : "#000000" }} />
                      </button>
                      <button onClick={() => setViewMode("list")} style={{ width: 30, height: 30, borderRadius: 8, border: "none", cursor: "pointer", background: viewMode === "list" ? "#de1a1a" : "rgba(0,0,0,0.04)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <List size={13} style={{ color: viewMode === "list" ? "#fff" : "#000000" }} />
                      </button>
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    <CloudUpload size={22} style={{ color: dragOver ? "#de1a1a" : "#000000", margin: "0 auto 6px" }} />
                    <p style={{ fontSize: 12, fontWeight: 600, color: dragOver ? "#de1a1a" : "#000000" }}>
                      Drag &amp; drop files here or click to upload
                    </p>
                    <p style={{ fontSize: 10, color: "#000000", marginTop: 3 }}>Supports: PDF, DOC, DOCX, PNG, JPG (Max 10MB)</p>
                  </div>
                  ...
                  {shownDocs.length === 0 ? (
                    <div style={{ background: "#fff", borderRadius: 20, padding: "48px 20px", textAlign: "center", border: "1px solid rgba(0,0,0,0.07)" }}>
                      ...
                      <p style={{ fontSize: 14, fontWeight: 700, color: "#000000" }}>No documents found</p>
                      <p style={{ fontSize: 12, color: "#000000", marginTop: 4 }}>Upload the first document for {selectedMember.name}</p>
                      <button onClick={() => { setUploadFor(selectedId); setShowUpload(true) }}
                  ...
                  {shownDocs.length > 0 && (
                    <button style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6, padding: "12px", borderRadius: 14, fontSize: 12, fontWeight: 700, color: "#000000", background: "rgba(0,0,0,0.03)", border: "1px solid rgba(0,0,0,0.06)", cursor: "pointer" }}>
              ...
              {activeTab === "personal" && (
                <div style={{ background: "#fff", borderRadius: 20, padding: "20px", border: "1px solid rgba(0,0,0,0.07)" }}>
                  <p style={{ fontSize: 11, fontWeight: 800, color: "#000000", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 14 }}>Personal Details</p>
              ...
              {activeTab === "kyc" && (
                <div style={{ background: "#fff", borderRadius: 20, padding: "20px", border: "1px solid rgba(0,0,0,0.07)" }}>
                  <p style={{ fontSize: 11, fontWeight: 800, color: "#000000", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 14 }}>KYC &amp; Bank Details</p>
                  {selectedKYC ? (
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
                    ...
                    <div style={{ textAlign: "center", padding: "32px 20px" }}>
                      ...
                      <p style={{ fontSize: 13, fontWeight: 600, color: "#000000" }}>No KYC records found for this employee</p>
                    </div>
                  )}
                </div>
              )}
              ...
              {activeTab === "activity" && (
                <div style={{ background: "#fff", borderRadius: 20, padding: "20px", border: "1px solid rgba(0,0,0,0.07)" }}>
                  <p style={{ fontSize: 11, fontWeight: 800, color: "#000000", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 16 }}>Activity Timeline</p>
                  {activityFeed.length === 0 ? (
                    <p style={{ fontSize: 13, color: "#000000", textAlign: "center", padding: "24px 0" }}>No activity yet</p>
                  ) : (
                      ...
                      {activityFeed.map((item, i) => (
                        <div key={i} style={{ display: "flex", gap: 14, position: "relative", paddingBottom: i < activityFeed.length - 1 ? 20 : 0 }}>
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <p style={{ fontSize: 11, color: "#000000", marginTop: 2 }}>{item.desc}</p>
                            <p style={{ fontSize: 10, color: "#000000", marginTop: 3 }}>{item.time}</p>
                          </div>
                        </div>
                      ))}
                    </div>
            ...
            <div style={{ background: "#fff", borderRadius: 20, padding: "64px 20px", textAlign: "center", border: "1px solid rgba(0,0,0,0.07)" }}>
              ...
              <p style={{ fontSize: 15, fontWeight: 700, color: "#000000" }}>Select an employee</p>
              <p style={{ fontSize: 12, color: "#000000", marginTop: 6 }}>Choose an employee from the list to view their documents</p>
            </div>
          )}
        </div>
        ...
        <div className="hidden lg:flex flex-col gap-3">
              ...
              {[
                ...
                <div key={i} style={{ display: "flex", gap: 10, position: "relative", paddingBottom: i < arr.length - 1 ? 16 : 0 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ fontSize: 10, color: "#000000", marginTop: 1 }}>{item.desc}</p>
                    <p style={{ fontSize: 9, color: "#000000", marginTop: 2 }}>{item.time}</p>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div style={{ marginTop: 14, display: "flex", justifyContent: "center", gap: 6, flexWrap: "wrap" }}>
              {[["#22C55E","Verified"],["#F59E0B","Pending"],["#EF4444","Rejected"]].map(([c,l]) => (
                <div key={l} style={{ display: "flex", alignItems: "center", gap: 4 }}>
                  ...
                  <span style={{ fontSize: 10, color: "#000000", fontWeight: 600 }}>{l}</span>
                </div>
              ))}
            </div>
            <p style={{ fontSize: 10, color: "#22C55E", fontWeight: 700, marginTop: 10 }}>
              ▲ 12% <span style={{ color: "#000000", fontWeight: 600 }}>vs last month</span>
            </p>
          </div>
          ...
          <div style={{
            ...
            <div style={{ padding: "16px 16px 0", textAlign: "center" }}>
              ...
              <p style={{ fontSize: 11, color: "#000000", lineHeight: 1.5 }}>All employee records are synced ☁️</p>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 px-4 md:px-5 pb-6 pt-3.5">
        ...
        <div style={{ background: "#fff", borderRadius: 20, border: "1px solid rgba(0,0,0,0.07)", boxShadow: "0 2px 12px rgba(0,0,0,0.05)", padding: "18px", display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: 11, color: "#000000" }}>{membersWithDocs} of {members.length} members have uploaded documents</p>
          </div>
        </div>
            ...
            {recentUploads.map(doc => {
              ...
              return (
                <div key={doc.id} style={{ flexShrink: 0, textAlign: "center", minWidth: 70 }}>
                  ...
                  <p style={{ fontSize: 10, fontWeight: 600, color: "#000000", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", maxWidth: 72 }}>{doc.name}</p>
                  <p style={{ fontSize: 9, color: "#000000", marginTop: 2 }}>{formatDateShort(doc.created_at)}</p>
                </div>
              )
            })}
            {recentUploads.length === 0 && (
              <p style={{ fontSize: 12, color: "#000000" }}>No uploads yet</p>
            )}
          </div>
        </div>
      </div>
            ...
            <div style={{ width: "100%", maxWidth: 440, borderRadius: 24, background: "#fff", boxShadow: "0 24px 80px rgba(0,0,0,0.2)", border: "1px solid rgba(222,26,26,0.12)", overflow: "hidden" }}>
              <div style={{ padding: "20px 24px 16px", borderBottom: "1px solid #F3F4F6", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 11, color: "#000000" }}>Add a new document to employee records</p>
                  </div>
                </div>
              ...
              <div style={{ padding: "20px 24px", display: "flex", flexDirection: "column", gap: 14 }}>
                {[
                  ...
                  <div key={label}>
                    <label style={{ display: "block", fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.12em", color: "#000000", marginBottom: 6 }}>{label}</label>
                    {el}
                  </div>
                ))}
                <div>
                  <label style={{ display: "block", fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.12em", color: "#000000", marginBottom: 6 }}>File *</label>
                  ...
                  <button onClick={() => fileRef.current?.click()}
                    style={{
                      ...
                      color: file ? "#de1a1a" : "#000000", background: file ? "rgba(222,26,26,0.04)" : "#F9FAFB",
              ...
              <div style={{ padding: "0 24px 20px", display: "flex", gap: 10 }}>
                <button onClick={() => setShowUpload(false)}
                  style={{ flex: 1, padding: "11px", borderRadius: 12, fontSize: 13, fontWeight: 600, background: "#F9FAFB", color: "#000000", border: "1px solid #E5E7EB", cursor: "pointer" }}>
                  Cancel
                </button>
