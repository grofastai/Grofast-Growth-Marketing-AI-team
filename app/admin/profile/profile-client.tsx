      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-[18px] items-start">
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    ...
                    <button onClick={() => setEditPersonal(false)}
                      style={{ display: "flex", alignItems: "center", gap: 5, padding: "9px 14px", borderRadius: 10, background: "#F5F6FA", border: "1px solid #EBEDF2", fontSize: 12, fontWeight: 700, color: "#6B7280", cursor: "pointer" }}>
                      <X size={11} /> Cancel
                    </button>
                  </div>
                </div>
              ...
              {editKYC ? (
                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  {([
                    ...
                    <div key={sec.title}>
                      <p style={{ fontSize: 11, fontWeight: 700, color: "#374151", margin: "0 0 7px" }}>{sec.title}</p>
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 7 }}>
                        {sec.fields.map(({ f, l }) => (
                          <div key={f}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                  ...
                  <button style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, width: "100%", padding: "11px", borderRadius: 12, background: "#F8F9FC", border: "1.5px solid #EBEDF2", fontSize: 12, fontWeight: 700, color: "#374151", cursor: "pointer", marginTop: 4 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 20, border: "1px solid #EBEDF2", padding: "20px", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
            ...
            <p style={{ fontSize: 11, color: "#9CA3AF", margin: "0 0 14px" }}>Click any photo to set as profile picture</p>
            ...
            <label style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 7, marginTop: 12, padding: "10px", borderRadius: 12, background: "#F9FAFB", border: "1.5px dashed #EBEDF2", cursor: "pointer", fontSize: 12, fontWeight: 600, color: "#6B7280" }}>
      ...
      {showPicker && (
        <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}
          ...
          <div style={{ position: "relative", background: "#fff", borderRadius: 24, padding: 24, width: "100%", maxWidth: 480, boxShadow: "0 24px 64px rgba(0,0,0,0.18)" }}
            ...
            <label style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, width: "100%", padding: "11px", borderRadius: 12, background: "#F8F9FC", border: "2px dashed #D1D5DB", cursor: "pointer", fontSize: 13, fontWeight: 600, color: "#6B7280" }}>
