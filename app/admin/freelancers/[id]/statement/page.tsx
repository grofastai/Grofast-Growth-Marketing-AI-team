      ...
      <body>
        ...
        <div className="header">
          <div>
            ...
            <div style={{ fontSize: 12, color: "#0F4C4C", marginTop: 4 }}>{company?.name ?? "GroFast Digital"}</div>
          </div>
          <div className="header-right">
            <div style={{ fontSize: 12, color: "#0F4C4C" }}>Printed on {printedOn}</div>
            <div style={{ fontSize: 12, color: "#0F4C4C", marginTop: 2 }}>Statement ref: {id.slice(0, 8).toUpperCase()}</div>
          </div>
        </div>
        ...
        <div className="meta-grid">
          <div className="meta-card">
            ...
            <div style={{ fontSize: 12, color: "#0F4C4C", marginTop: 2 }}>{TYPE_LABEL[freelancer.type] ?? "Freelancer"}</div>
            {freelancer.phone && <div style={{ fontSize: 12, color: "#0F4C4C" }}>{freelancer.phone}</div>}
          </div>
          <div className="meta-card">
            ...
            {freelancer.bank_name && (
              <>
                <div style={{ fontSize: 12, color: "#0F4C4C", marginTop: 2 }}>{freelancer.bank_name}</div>
                {freelancer.account_number && <div style={{ fontSize: 12, color: "#0F4C4C" }}>A/C: {freelancer.account_number}</div>}
                {freelancer.ifsc && <div style={{ fontSize: 12, color: "#0F4C4C" }}>IFSC: {freelancer.ifsc}</div>}
              </>
            )}
            {!freelancer.upi_id && !freelancer.bank_name && <div style={{ fontSize: 12, color: "#0F4C4C" }}>Not provided</div>}
          </div>
        </div>
