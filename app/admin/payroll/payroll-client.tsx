...
function SalaryHealthDonut({ pct }: { pct: number }) {
  ...
  return (
    <svg width={144} height={144} viewBox="0 0 144 144" style={{ display: "block", margin: "0 auto" }}>
      ...
      <text x={cx} y={cy + 10} textAnchor="middle" fontSize={10} fill="#000000">Salary</text>
      <text x={cx} y={cy + 23} textAnchor="middle" fontSize={10} fill="#000000">Processed</text>
    </svg>
  )
}
  ...
  return (
    <div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 2, marginBottom: 4 }}>
        {DAYS.map((d, i) => (
          <div key={i} style={{ textAlign: "center", fontSize: 9, fontWeight: 700, color: "#000000" }}>{d}</div>
        ))}
      </div>
      {weeks.map((week, wi) => (
      ...
      <div style={{ display: "flex", gap: 8, marginTop: 8, flexWrap: "wrap" }}>
        {[
          ...
          <div key={item.label} style={{ display: "flex", alignItems: "center", gap: 4 }}>
            ...
            <span style={{ fontSize: 9, color: "#000000" }}>{item.label}</span>
          </div>
        ))}
      </div>
    </div>
    ...
    <div style={{
      ...
      <div style={{ padding: "16px 22px", display: "flex", alignItems: "center", gap: 18, flexWrap: "wrap" }}>
        ...
        <div style={{ minWidth: 140 }}>
          ...
          <div style={{ fontSize: 11, color: "#000000", marginBottom: 5 }}>#{r.employee_id}</div>
        ...
        <div style={{ flexShrink: 0, textAlign: "center" }}>
          ...
          <div style={{ fontSize: 9, color: "#000000", marginTop: 2, fontWeight: 600 }}>Attendance</div>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", gap: 8, justifyContent: "center", flexWrap: "wrap" }}>
          {[
            ...
            <div key={chip.label} style={{
              ...
              <div style={{ fontSize: 10, color: "#000000", marginBottom: 3, fontWeight: 600 }}>{chip.label}</div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
          ...
          >
            {isExpanded
              ? <ChevronUp size={15} style={{ color: "#000000" }} />
              : <ChevronDown size={15} style={{ color: "#000000" }} />}
          </button>
          <a
      ...
      {isExpanded && (
        <div className="grid grid-cols-1 md:grid-cols-3" style={{ borderTop: "1.5px solid #F5F5F5" }}>
          ...
          <div style={{ padding: "22px 24px", borderRight: "1px solid #F5F5F5" }}>
            <div style={{ fontSize: 10, fontWeight: 800, color: "#000000", textTransform: "uppercase", letterSpacing: "0.13em", marginBottom: 18 }}>
              Payroll Breakdown
            </div>
            {[
              ...
              <div key={item.label} style={{ marginBottom: 14 }}>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 5 }}>
                  ...
                  <span style={{ fontSize: 12, fontWeight: 700, color: item.amount < 0 ? "#DC2626" : item.amount === 0 ? "#000000" : "#111" }}>
          ...
          <div style={{ padding: "22px 24px", background: "#FAFAFA" }}>
            ...
            <div style={{ marginBottom: 14 }}>
              <label style={{ fontSize: 11, fontWeight: 700, color: "#000000", display: "block", marginBottom: 6 }}>
                Bonus (₹)
              </label>
              <input
                type="number"
      ...
      {showConfirm && (
        <div style={{
          ...
          <div style={{ background: "#fff", borderRadius: 22, padding: "32px 36px", maxWidth: 420, width: "100%", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
            ...
            <p style={{ fontSize: 13, color: "#000000", textAlign: "center", margin: "0 0 20px", lineHeight: 1.6 }}>
            ...
            <div style={{ display: "flex", gap: 10 }}>
              <button
                ...
                style={{ flex: 1, padding: "12px", borderRadius: 12, border: "1.5px solid #E5E7EB", background: "#F9FAFB", fontSize: 13, fontWeight: 700, color: "#000000", cursor: "pointer" }}
              >
                Cancel
              </button>
              <button
      ...
      {showSettings && (
        <div style={{
          ...
          <div style={{ background: "#fff", borderRadius: 22, padding: "28px 32px", maxWidth: 480, width: "100%", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.3)" }}>
            ...
            <p style={{ fontSize: 12, color: "#000000", margin: "0 0 20px" }}>
              Changes apply from the next calculation onward — past paid months are not recalculated.
            </p>

            <p style={{ fontSize: 11, fontWeight: 800, color: "#000000", textTransform: "uppercase", letterSpacing: "0.05em", margin: "0 0 8px" }}>Attendance Rules</p>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 18 }}>
              {([
                ...
                <label key={key} style={{ display: "block" }}>
                  <span style={{ fontSize: 11, fontWeight: 600, color: "#000000", display: "block", marginBottom: 4 }}>{label}</span>
            ...
            <p style={{ fontSize: 11, fontWeight: 800, color: "#000000", textTransform: "uppercase", letterSpacing: "0.05em", margin: "0 0 8px" }}>Salary Breakdown (payslip only)</p>
            ...
            <p style={{ fontSize: 11, color: "#000000", margin: "0 0 20px" }}>
          ...
          actions={
            <>
              <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "9px 16px", borderRadius: 12, background: "#fff", border: "1.5px solid #E5E7EB" }}>
                ...
                <button onClick={() => changeMonth(-1)} style={{ background: "none", border: "none", cursor: "pointer", color: "#000000", fontSize: 18, lineHeight: 1, padding: "0 2px" }}>‹</button>
                <button onClick={() => changeMonth(1)}  style={{ background: "none", border: "none", cursor: "pointer", color: "#000000", fontSize: 18, lineHeight: 1, padding: "0 2px" }}>›</button>
              </div>
              <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_284px] gap-5">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
            {SUMMARY.map((card) => (
              <div key={card.label} style={{
                ...
                <div style={{ fontSize: 10, fontWeight: 700, color: "#000000", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 8 }}>
                  {card.label}
                </div>
                <div style={{ fontSize: 22, fontWeight: 900, color: card.color, fontFamily: "var(--font-jakarta)", lineHeight: 1, marginBottom: 4 }}>
                  {card.value}
                </div>
                <div style={{ fontSize: 10, color: "#000000", marginBottom: 8 }}>{card.sub}</div>
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, flexWrap: "wrap", gap: 10 }}>
              ...
              {selectMode ? (
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  <span style={{ fontSize: 12, fontWeight: 700, color: "#000000" }}>{selectedIds.size} selected</span>
                  <button onClick={handleBulkMarkPaid} disabled={selectedIds.size === 0 || isBulkRunning} style={{
                    ...
                    color: selectedIds.size === 0 ? "#000000" : "#fff",
            ...
            {rows.length === 0 ? (
              <div style={{ textAlign: "center", padding: "56px 0", borderRadius: 22, background: "#FAFAFA", border: "1.5px solid #E5E7EB" }}>
                ...
                <p style={{ fontSize: 14, fontWeight: 600, color: "#000000", margin: 0 }}>No active members found</p>
                <p style={{ fontSize: 12, color: "#000000", marginTop: 4 }}>Add team members to process payroll</p>
              </div>
            ) : (
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ borderRadius: 20, background: "#fff", border: "1.5px solid #EBEBEB", padding: "20px", boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }}>
            ...
            <p style={{ fontSize: 11, color: "#000000", margin: "0 0 16px" }}>Payroll processing status</p>
          ...
          <div style={{ borderRadius: 20, background: "#fff", border: "1.5px solid #EBEBEB", padding: "16px", boxShadow: "0 2px 12px rgba(0,0,0,0.04)" }}>
            ...
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ fontSize: 11, color: "#000000", margin: "0 0 14px" }}>Due 3rd {payMonthName} · Process before then.</p>
              <button
                onClick={handleRunPayroll}
                disabled={isRunning || unpaidRows.length === 0}
                style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              {[
                ...
                <button key={action.label} onClick={action.action} style={{
                  ...
                  <span style={{ fontSize: 10, fontWeight: 600, color: action.active ? "#E53935" : "#000000", textAlign: "center" }}>{action.label}</span>
                </button>
              ))}
            </div>
          </div>
