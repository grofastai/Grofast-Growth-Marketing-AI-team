    ...
    <>
      ...
      <div style={{
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "16px 24px 32px" }}>
          ...
          {dateGroups.length === 0 ? (
            <div style={{ textAlign: "center", padding: "48px 0", color: "#1b365d", fontSize: 13 }}>No work entries recorded</div>
          ) : (
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {dateGroups.map(([date, entries]) => (
                <div key={date}>
                  {/* Date header */}
                  <div style={{ fontSize: 11, fontWeight: 800, color: "#1b365d", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 8, paddingBottom: 6, borderBottom: "1px solid #F0F0F5" }}>
                ...
                return (
                  <div key={i} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      {startTime && endTime && (
                        <p style={{ fontSize: 10, color: "#1b365d", margin: "5px 0 0" }}>{startTime} – {endTime}</p>
                      )}
                    </div>
                    {/* Duration */}
                    {durationH > 0 && (
                      <div style={{ flexShrink: 0, textAlign: "right" }}>
                        ...
                        <div style={{ fontSize: 9, color: "#1b365d", textTransform: "uppercase", marginTop: 1 }}>⏱</div>
                      </div>
                    )}
                  </div>
                )
          ...
          {notes && (
            <div style={{ marginTop: 16, padding: "12px 16px", borderRadius: 12, background: "rgba(99,102,241,0.05)", border: "1px solid rgba(99,102,241,0.15)" }}>
              ...
              <div style={{ fontSize: 12, color: "#1b365d", lineHeight: 1.6 }}>{notes}</div>
            </div>
          )}

          {/* Submission time */}
          {firstUpdate.created_at && (
            <div style={{ marginTop: 14, fontSize: 11, color: "#1b365d", textAlign: "center" }}>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5" style={{ gap: 14, marginBottom: 20 }}>
        {[
          ...
          <div key={card.label} style={{
            ...
            <div>
              <div style={{ fontSize: 11, color: "#1b365d", fontWeight: 600, marginBottom: 4 }}>{card.label}</div>
              <div style={{ fontSize: 26, fontWeight: 800, color: "#111827", lineHeight: 1 }}>{card.value}</div>
              <div style={{ fontSize: 11, color: "#1b365d", marginTop: 3 }}>{card.sub}</div>
            </div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 20, overflowX: "auto", flexWrap: "nowrap", alignItems: "center", paddingBottom: 4 }}>
        {DATE_PRESETS.map(p => (
          <button
            ...
            style={{
              ...
              color: curPreset === p.label ? "#fff" : "#1b365d",
        ...
        <button
          ...
          style={{
            ...
            color: curPreset === "Custom" ? "#fff" : "#1b365d",
        ...
        {showCustom && (
          <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
            <input type="date" max="2099-12-31" value={customFrom} onChange={e => setCustomFrom(e.target.value)}
              style={{ padding: "6px 10px", borderRadius: 8, border: "1px solid #E5E7EB", fontSize: 12, color: "#1b365d" }} />
            <span style={{ fontSize: 12, color: "#1b365d" }}>to</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px]" style={{ gap: 20 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 20, boxShadow: "0 1px 3px rgba(0,0,0,0.06), 0 4px 20px rgba(0,0,0,0.04)", overflow: "hidden" }}>
          ...
          <div style={{ padding: "20px 24px 16px", borderBottom: "1px solid #F3F4F6", display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 11, color: "#1b365d" }}>{filteredPeople.length} member{filteredPeople.length !== 1 ? "s" : ""} updated · click to view details</div>
            </div>
          </div>
          ...
          <div style={{ padding: "8px 0 16px" }}>
            {filteredPeople.length === 0 && (
              <div style={{ textAlign: "center", padding: "48px 24px", color: "#1b365d", fontSize: 13 }}>
                No activities found
              </div>
            )}
                ...
                >
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 12, flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ minWidth: 0 }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 3, flexWrap: "wrap" }}>
                          ...
                          {entryCount > 0 && (
                            <span style={{ fontSize: 10, color: "#1b365d", fontWeight: 600 }}>{entryCount} {entryCount === 1 ? "entry" : "entries"}</span>
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
                      {totalHours > 0 && (
                        <span style={{ fontSize: 12, fontWeight: 700, color: "#1b365d", display: "flex", alignItems: "center", gap: 3 }}>
                          <Clock size={11} color="#1b365d" /> {fmtHours(totalHours)}
                        </span>
                      )}
                      <span style={{ fontSize: 11, color: "#1b365d", whiteSpace: "nowrap" }}>{time}</span>
                      <ChevronRight size={15} color={isSelected ? "#E31E24" : "#1b365d"} style={{ transition: "color 0.15s" }} />
                    </div>
                  </div>
                </div>
              )
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 20, padding: "20px", boxShadow: "0 1px 3px rgba(0,0,0,0.06), 0 4px 20px rgba(0,0,0,0.04)" }}>
            ...
            <div style={{ position: "relative", height: 160 }}>
              ...
              <div style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", textAlign: "center", pointerEvents: "none" }}>
                ...
                <div style={{ fontSize: 10, color: "#1b365d", lineHeight: 1.2 }}>Update<br/>Completion</div>
              </div>
            </div>
              ...
              {donutData.map(d => (
                <div key={d.name} style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <span style={{ fontSize: 12, color: "#1b365d" }}>{d.name}</span>
                  </div>
                  <span style={{ fontSize: 12, fontWeight: 600, color: "#1b365d" }}>{d.pct}% ({d.value})</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div style={{ background: "#fff", borderRadius: 20, padding: "20px", boxShadow: "0 1px 3px rgba(0,0,0,0.06), 0 4px 20px rgba(0,0,0,0.04)", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ fontSize: 11, color: "#1b365d", marginBottom: 16 }}>{stats.notUpdated} member{stats.notUpdated !== 1 ? "s" : ""} haven&apos;t updated yet</div>
            {stats.notUpdatedMembers.length > 0 ? (
              <div style={{ display: "flex", alignItems: "center", gap: 0, marginBottom: 16 }}>
                ...
                {stats.notUpdatedMembers.length > 5 && (
                  <div style={{
                    width: 32, height: 32, borderRadius: "50%", background: "#F3F4F6", color: "#1b365d",
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: "#1b365d", marginTop: 2 }}>{topContributor.count} Update{topContributor.count !== 1 ? "s" : ""}</div>
                  </div>
                </div>
