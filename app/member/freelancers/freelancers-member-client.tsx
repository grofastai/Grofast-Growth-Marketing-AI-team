        ...
        <div style={{ flex: 1, overflowY: "auto" }}>
          {!selectedFreelancer ? (() => {
            ...
            return (
              <div>
                {/* HERO BANNER */}
                <div style={{ margin: "16px 16px 0", borderRadius: 24, overflow: "hidden", background: `linear-gradient(135deg, ${cfg.color} 0%, ${cfg.color} 20%, #171717 68%, #050505 100%)`, boxShadow: `0 10px 38px ${cfg.color}3D`, position: "relative", minHeight: 210 }}>
