...
function Section({ title, items }: { title: string; items: NotificationRow[] }) {
  ...
  return (
    <div style={{ marginBottom: 28 }}>
      <p style={{
        fontSize: 11, fontWeight: 800, color: "#1b365d",
      ...
      <div style={{ background: '#fff', borderBottom: '1px solid #EBEDF2' }} className="px-4 md:px-7 py-5">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div>
            ...
            <p style={{ fontSize: 12, color: "#1b365d", margin: 0 }}>
        ...
        {!hasAny ? (
          <div style={{ textAlign: 'center', paddingTop: 80 }}>
            <div style={{ width: 72, height: 72, borderRadius: 24, background: '#F3F4F6', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 16px' }}>
              <Bell size={32} style={{ color: "#1b365d" }} />
            </div>
            <p style={{ fontSize: 16, fontWeight: 800, color: "#1b365d", margin: '0 0 6px' }}>No notifications yet</p>
            <p style={{ fontSize: 13, color: "#1b365d", maxWidth: 280, margin: '0 auto' }}>
